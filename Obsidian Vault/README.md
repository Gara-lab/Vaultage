...
Each project folder's `decisions.md` links down to its own `logs/` entries — start
here and drill in:

- [[Checkout flow optimization/decisions|Checkout flow optimization]]
- [[Graphify/decisions|Graphify]]
- [[Interface builder/decisions|Interface builder]]
- [[Interface builder V2/decisions|Interface builder V2]]
- [[Library templates/decisions|Library templates]]
- [[Loan_application_requirement/decisions|Loan_application_requirement]]
- [[Markdown-powered blog_portfolio/decisions|Markdown-powered blog_portfolio]]
- [[REST API/decisions|REST API]]
- [[Saas metrics dashboard/decisions|Saas metrics dashboard]]
- [[Storage interface/decisions|Storage interface]]
- [[Store dynamic database/decisions|Store dynamic database]]
- [[V2/decisions|V2]]
